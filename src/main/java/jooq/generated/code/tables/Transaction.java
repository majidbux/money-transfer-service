...
public class Transaction extends TableImpl<TransactionRecord> {
    ...
    private static final long serialVersionUID = -1051150799;
     ...
     */
    public final TableField<TransactionRecord, Integer> TYPE = createField(DSL.name("TYPE"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<TransactionRecord, BigDecimal> AMOUNT = createField(DSL.name("AMOUNT"), org.jooq.impl.SQLDataType.DECIMAL.nullable(false), this, "");

    /**
     * The column <code>PUBLIC.TRANSACTION.TRANSFER_ID</code>.
     */
    public final TableField<TransactionRecord, UUID> TRANSFER_ID = createField(DSL.name("TRANSFER_ID"), org.jooq.impl.SQLDataType.UUID.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PRIMARY_KEY_F, Indexes.TRANSACTION_ACCOUNT_ID_FK_INDEX_F, Indexes.TRANSACTION_TRANSFER_ID_FK_INDEX_F);
    }
    ...
    public List<ForeignKey<TransactionRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<TransactionRecord, ?>>asList(Keys.TRANSACTION_ACCOUNT_ID_FK, Keys.TRANSACTION_TRANSFER_ID_FK);
    }

    public Account account() {
        return new Account(this, Keys.TRANSACTION_ACCOUNT_ID_FK);
    }

    public Transfer transfer() {
        return new Transfer(this, Keys.TRANSACTION_TRANSFER_ID_FK);
    }
